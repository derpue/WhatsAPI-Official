...
abstract class AllEvents
{
    ...
    public function onGroupisCreated( $mynumber, $groupID, $creatorJID, $creationTime, $groupSubject,
                                                $groupMembers, $groupAdmins, $issuerJID, $issuerName, $notificationTime, $creationType){}
