...
class WhatsProt
{
     ...
     * @return string|null Message ID if successfully, null if not.
     */
    public function sendMessageImage($to, $filepath, $storeURLmedia = false, $fsize = 0, $fhash = '', $caption = '', $bcJID = null, $bcListName = null, $encrypted = false)
    {
...
//          $height = $json->height;
    ...
    protected function sendBroadcast($targets, $node, $type, $bcJID = null, $bcListName = null)
    {
        ...
        $broadcastNode = new ProtocolNode('broadcast', ($bcListName) ? ['name' => $bcListName] : null, $toNodes, null);
